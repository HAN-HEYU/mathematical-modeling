...
def load_inputs() -> dict[str, Any]:
    """Load and validate Q5 attachments."""
    return {}
...
def solve(model: Any, inputs: dict[str, Any]) -> dict[str, Any]:
    """Solve Q5 and return serializable result data."""
    del model, inputs
    return {"question": QUESTION, "status": "template_ready"}

def validate(result: dict[str, Any]) -> None:
    """Check Q5 constraints, units, bounds, and numerical sanity."""
...
def plot_results(result: dict[str, Any]) -> Path:
    """Create Q5 figures here after defining a figure contract."""
    del result
    return ensure_dir(FIGURES_DIR / QUESTION)


def main() -> dict[str, Any]:
    """Run the complete Q5 template pipeline."""
