...
def load_inputs() -> dict[str, Any]:
    """Load and validate Q2 attachments."""
    return {}
...
def solve(model: Any, inputs: dict[str, Any]) -> dict[str, Any]:
    """Solve Q2 and return serializable result data."""
    del model, inputs
    return {"question": QUESTION, "status": "template_ready"}

def validate(result: dict[str, Any]) -> None:
    """Check Q2 constraints, units, bounds, and numerical sanity."""
...
def plot_results(result: dict[str, Any]) -> Path:
    """Create Q2 figures here after defining a figure contract."""
    del result
    return ensure_dir(FIGURES_DIR / QUESTION)


def main() -> dict[str, Any]:
    """Run the complete Q2 template pipeline."""
